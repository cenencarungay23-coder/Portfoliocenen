...
const PROJECTS = [
  ...
  {slug:'dsa',          dom:'dsa.clinic',               kind:'wordpress',   sector:'Medical clinic',      year:'2025', layout:'grid'},
  {slug:'galialahav',   dom:'galialahav.com',           kind:'woocommerce', sector:'Bridal couture',      year:'2024', layout:'shop'},
  {slug:'omahabeach',   dom:'omahabeachgolfclub.com',   kind:'woocommerce', sector:'Golf club',           year:'2022', layout:'grid'},
  ...
  {slug:'mightyroar',   dom:'themightyroar.co.uk',      kind:'php',         sector:'Creative studio',     year:'2016', layout:'editorial'},
  {slug:'homesihave',   dom:'thehomesihavemade.com',    kind:'php',         sector:'Home & lifestyle',    year:'2019', layout:'grid'},
  {slug:'yeshair',      dom:'yeshair.com.au',           kind:'shopify',     sector:'Hair care',           year:'2026', layout:'shop'},
  {slug:'igkhair',      dom:'igkhair.com',              kind:'shopify',     sector:'Hair care',           year:'2026', layout:'shop'},
...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  function renderLogo() {
    ...
    function typeWord() {
      if (wordIndex >= words.length) {
        setTimeout(() => { caret.style.display = 'none'; }, 1000);
        return;
      }
  ...
  if (nav) {
    const navInner = nav.querySelector('.in');
    const links = nav.querySelector('.links');

    if (navInner && links && !nav.querySelector('.menu-toggle')) {
